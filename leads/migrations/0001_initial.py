# Generated by Django 5.0.6 on 2024-06-09 14:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(default='NA', on_delete=django.db.models.deletion.CASCADE, to='leads.agent')),
                ('buyer', models.ForeignKey(default='NA', on_delete=django.db.models.deletion.CASCADE, to='leads.buyer')),
                ('campaign', models.ForeignKey(default='NA', on_delete=django.db.models.deletion.CASCADE, to='leads.campaign')),
                ('supplier', models.ForeignKey(default='NA', on_delete=django.db.models.deletion.CASCADE, to='leads.supplier')),
            ],
        ),
    ]
